...
# Diccionario de emojis según condición
WEATHER_EMOJIS = {
    "clear sky": "☀️",
    "few clouds": "🌤️",
    "scattered clouds": "☁️",
...
class WeatherApp(QWidget):
    ...
    def update_weather(self):
        try:
            ...
            # Buscar emoji según descripción
            emoji = WEATHER_EMOJIS.get(desc.lower(), "🌍")

            self.temp_label.setText(f"Temperatura: {temp:.1f} °C 🌡️")
            self.desc_label.setText(f"Condición: {desc.capitalize()} {emoji}")
